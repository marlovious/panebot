...
fn render_startup_screen(
    ...
    terminal.draw(|f| {
        ...
        // entry list — pad name column to longest
    ...
    if !conf_path.exists() || panes.is_empty() {
        let entries = vec![StartupEntry {
            ...
            message: if !conf_path.exists() {
                "panes.conf not found -- Press [Enter] to create panes.".to_string()
            } else {
                        ...
                        match key.code {
                            ...
                            KeyCode::Enter => {
                                ...
                                if !input.is_empty() {
                                    ...
                                    if is_stream {
                                        // append URL to m3u, loadfile into mpv
                                        ...
                                        // expand dir if needed, append all paths to m3u, loadfile each
